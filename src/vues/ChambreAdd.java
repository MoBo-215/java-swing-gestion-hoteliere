...
public class ChambreAdd extends JPanel {
	...
	public ChambreAdd() {
		...
		JLabel lblChambreAdd = new JLabel("Ajouter une chambre");
		lblChambreAdd.setBounds(0, 100, 1040, 51);
		lblChambreAdd.setHorizontalAlignment(SwingConstants.CENTER);
		lblChambreAdd.setFont(new Font("Calibri", Font.BOLD, 40));
		add(lblChambreAdd);
		...
		btnAjouter.setBounds(401, 643, 243, 59);
